...
class TrackEight extends StatefulWidget {
  @override
  _TrackEightState createState() => _TrackEightState();
}

AudioPlayer newPlayer = new AudioPlayer();
AudioCache audio = new AudioCache(fixedPlayer: newPlayer);

class _TrackEightState extends State<TrackEight> {
  bool play = false;
  bool stop = true;
  ...
  playAudio() {
    if (play == false || stop == true) {
      ...
      audio.play("music/'DANCE MONKEY' - STREET SAX PERFORMANCE.mp3");
      play = true;
      stop = false;
    }
  }
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage('assets/Danielle.jpg')),
