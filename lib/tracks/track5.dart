...
class TrackFive extends StatefulWidget {
  @override
  _TrackFiveState createState() => _TrackFiveState();
}

AudioPlayer newPlayer = new AudioPlayer();
AudioCache audio = new AudioCache(fixedPlayer: newPlayer);

class _TrackFiveState extends State<TrackFive> {
  bool play = false;
  bool stop = true;
  ...
  playAudio() {
    if (play == false || stop == true) {
      ...
      audio.play(
          "music/Eminem - Godzilla ft. Juice WRLD (Dir. by @_ColeBennett_).mp3");
      play = true;
      stop = false;
    }
  }
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage('assets/Godzilla.jpg')),
