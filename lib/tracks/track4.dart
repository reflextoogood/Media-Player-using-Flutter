...
class TrackFour extends StatefulWidget {
  @override
  _TrackFourState createState() => _TrackFourState();
}

AudioPlayer newPlayer = new AudioPlayer();
AudioCache audio = new AudioCache(fixedPlayer: newPlayer);

class _TrackFourState extends State<TrackFour> {
  bool play = false;
  bool stop = true;
  ...
  playAudio() {
    if (play == false || stop == true) {
      ...
      audio.play(
          "music/ES_When I Get Sober (Instrumental Version) - waykap.mp3");
      play = true;
      stop = false;
    }
  }
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage('assets/waykap.jpg')),
