...
class TrackSix extends StatefulWidget {
  @override
  _TrackSixState createState() => _TrackSixState();
}

AudioPlayer newPlayer = new AudioPlayer();
AudioCache audio = new AudioCache(fixedPlayer: newPlayer);

class _TrackSixState extends State<TrackSix> {
  bool play = false;
  bool stop = true;
  ...
  playAudio() {
    if (play == false || stop == true) {
      ...
      audio.play("music/Roddy Ricch - The Box [Official Music Video].mp3");
      play = true;
      stop = false;
    }
  }
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage('assets/The_box.jpg')),
